...
import { Button, List, Tabs, Icon, Avatar, Paper, Divider, SubHeader, GridList } from 'muse-ui'
import theme from 'muse-ui/lib/theme'
theme.use('light') // 使用 light 主题
Vue.use(Button).use(List).use(Tabs).use(Icon).use(Avatar).use(Paper).use(Divider).use(SubHeader).use(GridList)
